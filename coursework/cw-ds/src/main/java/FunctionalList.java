 ...
 *
 * <p>Not all operations on a recursive list will always be
...
public interface FunctionalList extends List {
   ...
   * 
   * <p>If the list is empty, an appropriate error is returned.</p>
   *
   ...
   * 
   * <p>If the list is empty, another empty list is returned.</p>
   */
