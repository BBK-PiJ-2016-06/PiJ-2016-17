 ...
 * 
 * <p>Classes implementing this interface must use a {@see List} as the
 * underlying data structure to store the elements on the stack.</p>
 * 
 * <p>Not all operations on a stack will always be successful. For
...
public interface ImprovedStack extends Stack {
   ...
   *
   * <p>Classes implementing this method must use method .equals() to
   * check whether the item is in the stack or not.</p>
   * 
